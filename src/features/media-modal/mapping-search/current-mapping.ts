...
const parseLinkedAniListIds = (ids: readonly number[] | undefined): AniListId[] | undefined => {
...
function buildFallbackMapping(input: {
  ...
  return {
    ...
    ...(input.providerRouteSlug ? { providerRouteSlug: input.providerRouteSlug } : {}),
...
function deriveRadarrCurrentMapping(input: {
  ...
  const linkedAniListIds = parseLinkedAniListIds(input.status?.linkedAniListIds);
  ...
  return buildFallbackMapping({
    ...
    isInLibrary,
    providerRouteSlug: getProviderRouteSlug('radarr', movie as ProviderMediaPathSource | undefined),
    linkedAniListIds,
  });
}
...
function deriveSonarrCurrentMapping(input: {
  ...
  return buildFallbackMapping({
    ...
    isInLibrary,
    providerRouteSlug: getProviderRouteSlug('sonarr', series as ProviderMediaPathSource | undefined),
    linkedAniListIds,
  });
}
