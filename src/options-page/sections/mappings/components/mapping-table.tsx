/** Mapping table used by the options-page mappings section. */
// src/options-page/sections/mappings/components/mapping-table.tsx
...
export const MappingTable: React.FC<MappingTableProps> = ({
  ...
  const handleValueChange = useCallback(
    (newValue: string[]) => {
      const nextExpanded = newValue.length > 0 ? [newValue.at(-1)!] : [];
